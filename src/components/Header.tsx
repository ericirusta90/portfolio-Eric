	...
	return (
		<>
			<div className='flex flex-col sm:flex-row gap-6 sm:gap-12'>
				...
				<div className='flex flex-col gap-3 flex-1 items-center text-center sm:items-start sm:text-left'>
					...
					<div className='flex gap-2 mt-4'>
						<a
							...
							className='bg-[#128C7E] text-white rounded-md flex gap-1.5 items-center justify-center px-5 font-semibold'
							target='_blank'
